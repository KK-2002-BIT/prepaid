...
csv_filename = f"C://Users//Archi Jain//OneDrive//Desktop//API//Api-Automation//data1.csv"
...
for row in rows:
    ...
    consumption_min = int(row['consumption_min'])
    consumption_max = int(row['consumption_max'])
